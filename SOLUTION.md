...
Já dentro da AWS vamos ter o seguinte:
    ...
    - Um sagemaker pipeline que gera uma nova versão do modelo e registra no sagemaker model registry como latest;
    ...
    - Um sagemaker pipeline que vai rodar o modelo atual que temos já treinado após ele ser versionado no model registry (vamos registrar ele manualmente com o terraform após subir ele no S3) e uma pasta no bucket anterior para salvar os resultados da predição dele;
